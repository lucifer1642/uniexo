        ...
        >
          <div className="text-center mb-10">
            ...
            <p className="mt-4 text-zinc-400 font-medium">
              Already with us?{' '}
              <Link href="/login" className="text-lime-400 hover:text-lime-300 transition-colors font-bold">
                Log in here
              </Link>
            </p>
          </div>
          ...
          <div className="backdrop-blur-3xl bg-white/[0.02] border border-white/10 shadow-2xl rounded-[2.5rem] p-8 sm:p-12">
            ...
            <form className="grid grid-cols-1 sm:grid-cols-2 gap-6" onSubmit={handleSubmit}>
              ...
              {error && (
                <div className="sm:col-span-2 text-red-400 text-xs font-medium bg-red-500/10 border border-red-500/20 py-2.5 px-4 rounded-xl">
                  {error}
                </div>
              )}
              ...
              <Button 
                type="submit" 
                className="sm:col-span-2 w-full h-14 text-black bg-lime-400 hover:bg-lime-300 font-black text-lg rounded-2xl transition-all shadow-xl shadow-lime-500/20 active:scale-[0.99] mt-2" 
                disabled={loading}
              >
